...
class AttendanceService {
    ...
    public function getAttendanceState($employee_id, $punchInDate, $punchOutDate){

        return $this->getAttendanceDao()->getAttendanceState($employee_id, $punchInDate, $punchOutDate);
    }
