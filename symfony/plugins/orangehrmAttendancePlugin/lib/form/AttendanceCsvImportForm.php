 ...
 *
 */
class AttendanceCsvImportForm extends BaseForm {

	private $attendanceCsvDataImportService;
	
	public function getAttendanceCsvDataImportService() {
		if (is_null($this->attendanceCsvDataImportService)) {
			$this->attendanceCsvDataImportService = new AttendanceCsvDataImportService();
		}
		return $this->attendanceCsvDataImportService;
	}
	...
	public function configure() {
		...
		$this->widgetSchema->setNameFormat('attendanceCsvImport[%s]');
	}
	...
	public function save() {
		...
		if (!empty($file)) {
			...
			return $this->getAttendanceCsvDataImportService()->import($file);
		}
	}
